...
- creating and updating course content and examples as needed
...
- 1 Starter Kit for Each assignment, Lab and In Class
    ...
    - this is only for the assignments that use github/github classroom.
- 1 Primary Course Repository (with the following files and directories.)
  ...
  - **lab/ or in-class-assessments/ or quizzes/** (use only the folders that are applicable.)
    - 1 folder for each
      - a README.md that links to the starter kit.
      - the folder for the assignment starter
      - the folder for assignment solutions
      - Either a csv for quizzes or a note that they can be found on brightspace with a link to the brightspace primary
  - **admin/** (optional)
